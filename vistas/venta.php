            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h1 class="box-title">Ventas <button class="btn btn-success" id="btnagregar"
                        ...
                        <form action="" name="formulario" id="formulario" method="POST">
                            ...
                            <div class="form-group col-lg-4 col-md-4 col-xs-12">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input class="form-control pull-right" type="date" name="fecha_hora" id="fecha_hora"
                                        required>
                                </div>
                                <!-- /.input group -->
                            </div>
                            <div class="form-group col-lg-4 col-md-4 col-xs-12">
                                ...
                                <select onchange="ShowComprobante()" name="tipo_comprobante" id="tipo_comprobante"
                            ...
                            <div class="form-group table-responsive col-lg-12 col-md-12 col-xs-12">
                                <table id="detalles"
                                    ...
                                    <tfoot style="background-color:#A9D0F5">
                                        <th><span>SubTotal</span><br><span
                                                id="valor_impuesto"><?php echo $tipo_impuesto; ?>
                                                0.00</span><br><span>TOTAL</span></th>
                                        <th></th>
                                        <th></th>
                                        <th></th>
                                        <th></th>
                                        <th><span id="total"><?php echo $smoneda; ?> 0.00</span><br><span id="most_imp"
                                                maxlength="4">0.00</span><br><span id="most_total">0.00</span><input
                                                type="hidden" step="0.01" name="total_venta" id="total_venta"></th>
                                    </tfoot>
                                    <tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-lg-4 col-md-4 col-xs-12">
                    <label for="">Número: </label>
                    <input class="form-control" type="text" name="num_comprobantem" id="num_comprobantem" maxlength="10"
                        readonly>
                </div>
                <div class="form-group col-lg-4 col-md-4 col-xs-12">
