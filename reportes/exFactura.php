...
$timbrado = $regn->timbrado;
$fecha_inicio = $regn->fecha_inicio;
$fecha_fin = $regn->fecha_fin;
...
$pdf->fact_dev("$regv->tipo_comprobante ","$regv->serie_comprobante- $regv->num_comprobante",$timbrado,$fecha_inicio,$fecha_fin);
//$pdf->addFacture("$regv->serie_comprobante- $regv->num_comprobante",$timbrado,$fecha_inicio,$fecha_fin);
$pdf->temporaire( "" );
