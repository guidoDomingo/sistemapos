...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-09-2020 a las 05:46:39
...
(1, 'Ticket', '010', '9999999', 1),
(2, 'Boleta', '001', '9999999', 1),
...
(2, 'Compartiendo Códigos', 'RUC', 2332112, 'calle nueva', 3717027, 'info@compartiendocodigos.com', 'default.png', 'Perú', 'Arequipa', 'IGV', 18.00, 'SOLES', 'S/.', 1);
...
(1, 'demo', 'DNI', '72154871', 'Calle los alpes 210', '547821', 'admin@gmail.com', 'Administrador', 'admin', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', 'default.png', 1),
(2, 'juancho', 'DNI', '30115425', 'calle los jirasoles 450', '112233', 'juan@hotmail.com', 'vendedor', 'juan', 'ed08c290d7e22f7bb324b15cbadce35b0b348564fd2d5f95752388d86d71bcca', 'default.png', 1);
...
--
ALTER TABLE `comp_pago`
  MODIFY `id_comp_pago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
